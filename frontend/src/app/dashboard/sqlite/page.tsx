...
import { sqliteTexts } from '@/constants/static/sqlite/sqliteTexts';
...
const Page = () => {
  ...
  return (
    <React.Fragment>
      {settingsBar && <ConnectionSettings dbType="sqlite" key={key} />}
      <div className="w-full flex my-6 flex-col">
        <div className="flex w-full justify-between items-center py-2 px-4">
          <div className=" font-semibold text-4xl text-Pri-Dark">Sqlite</div>
          <div>
            <button
